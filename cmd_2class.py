...
def gps_main(gps_status, weg_num, frame_num, camera_command, take_pic):
    """
...
def command_thread(loaction, weg_num, frame_num, camera_command, take_pic):
    local_pic = False
    foto_location = (0, 0)
    i = 1
    auto = False
...
class RScam:
    ...
    def gps_on(self):
        gps_process = mp.Process(target=gps_main, args=(self.gps_status, self.num, self.frame_num,
